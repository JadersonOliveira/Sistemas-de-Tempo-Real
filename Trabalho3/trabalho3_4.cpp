...
void thread_function1(sf::Sprite *trem);
void thread_function2(sf::Sprite *trem);
void thread_function3(sf::Sprite *trem);
void thread_function4(sf::Sprite *trem);
...
int main(){
  ...
  std::vector<sf::RectangleShape> quadrados_linha2;
  std::vector<sf::RectangleShape> quadrados_linha3;
  std::vector<sf::RectangleShape> quadrados_linha4;
  std::vector<sf::RectangleShape> quadrados_linha5;
  std::vector<sf::RectangleShape> quadrados_linha6;
  std::vector<sf::RectangleShape> quadrados_linha7;
  std::vector<sf::RectangleShape> quadrados_linha8;
  std::vector<sf::RectangleShape> quadrados_linha9;
  ...
  for(int  j=0; j<3; j++)
  {
    for (int i=0; i<13; i++)
    {
      ...
      // quadrado.setSize(sf::Vector2f(dim_x,dim_y));
      // quadrado.setOutlineColor(sf::Color::Red);
      //quadrado.setTexture(tilho_1);
  ...
  sf::Sprite trem_1;
  // trem_1.setSize(sf::Vector2f(dim_x,dim_y));
  // trem_1.setOutlineColor(sf::Color::Red);
  // trem_1.setFillColor(sf::Color::Green);
  // trem_1.setOutlineThickness(1);
  ...
  sf::Sprite trem_2;
  // trem_2.setSize(sf::Vector2f(dim_x,dim_y));
  // trem_2.setOutlineColor(sf::Color::Red);
  // trem_2.setFillColor(sf::Color::Magenta);
  // trem_2.setOutlineThickness(1);
  trem_2.setTexture(trem_rosa);
  trem_2.setPosition(x_inicial, y_inicial);
  trem_2.move(dim_x*5,0);

  sf::Sprite trem_3;
  // trem_3.setSize(sf::Vector2f(dim_x,dim_y));
  // trem_3.setOutlineColor(sf::Color::Red);
  // trem_3.setFillColor(sf::Color::Red);
  // trem_3.setOutlineThickness(1);
  trem_3.setTexture(trem_vermelho);
  trem_3.setPosition(x_inicial, y_inicial);
  trem_3.move(dim_x*9,0);

  sf::Sprite trem_4;
  // trem_4.setSize(sf::Vector2f(dim_x,dim_y));
  // trem_4.setOutlineColor(sf::Color::Red);
  // trem_4.setFillColor(sf::Color::Blue);
  // trem_4.setOutlineThickness(1);
  ...
  sf::Thread thread(&thread_function1, &trem_1);	// create a thread
  thread.launch();	// run it
  sf::Thread thread2(&thread_function2, &trem_2);	// create a thread
  thread2.launch();	// run it
  sf::Thread thread3(&thread_function3, &trem_3);	// create a thread
  thread3.launch();	// run it
  sf::Thread thread4(&thread_function4, &trem_4);	// create a thread
